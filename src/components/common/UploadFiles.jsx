...
const UploadFiles = ({ onFileSelect, label, title, style }) => {
    ...
    const [isApplied, setIsApplied] = useState(false); // Track Apply state
    ...
    const handleApply = () => {
        setIsApplied(true); // Hide label and show updated document
    };
    ...
    return (
        <div>
            {/* Hide label when file is applied */}
            {!isApplied && (
            ...
            <div className='relative'>
                {!isApplied ? (
                    ...
                    <div className='updated-document'>
                        <div className='mt-2 gap-3 py-2 px-4 w-full bg-gray-100 rounded-lg shadow'>
                            <div className='flex items-center justify-between'>
                                <div className='flex align-middle items-center gap-x-3'>
                                    <div>{selectedFile.icon}</div>
                                    <div>
